...
const sliderRules = {
  ...
  steps: { min: 0, max: 30000, step: 1, label: '걸음 수', unit: '걸음' },
...
export default function CheckinPage() {
  ...
  const onSave = async () => {
    try {
      await healthRecordApi.saveToday(form);
      setForm({ water_ml: 0, steps: 0, exercise_minutes: 0 });
      setMessage('저장 완료: 입력값이 초기화되었습니다.');
    } catch (err) {
