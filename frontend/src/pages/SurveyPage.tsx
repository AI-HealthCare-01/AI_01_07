          ...
          <div className="formGrid">
            ...
            <label>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    gender: e.target.value as OnboardingSurveyRequest["gender"],
                  }))
                }
              >
            ...
            <label>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((prev) => ({ ...prev, height_cm: Number(e.target.value) }))
                }
              />
            </label>
            <label>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((prev) => ({ ...prev, weight_kg: Number(e.target.value) }))
                }
              />
            </label>
            ...
            <label>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    family_history: e.target.value as OnboardingSurveyRequest["family_history"],
                  }))
                }
              >
            ...
            <label>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    hypertension: e.target.value as OnboardingSurveyRequest["hypertension"],
                  }))
                }
              >
                <option value="yes">네</option>
            ...
            <label>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    hyperlipidemia: e.target.value as OnboardingSurveyRequest["hyperlipidemia"],
                  }))
                }
              >
                <option value="yes">네</option>
            ...
            <label>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    smoking_status: e.target.value as OnboardingSurveyRequest["smoking_status"],
                  }))
                }
              >
            ...
            <label>
              8. 음주 빈도
              <select
                value={form.drinking_freq}
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    drinking_freq: e.target.value as OnboardingSurveyRequest["drinking_freq"],
                  }))
                }
              >
            ...
            <label>
              ...
              <select
                value={form.exercise_days_30m}
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    exercise_days_30m: e.target.value as OnboardingSurveyRequest["exercise_days_30m"],
                  }))
                }
              >
            ...
            <label>
              10. 당음료 빈도
              <select
                value={form.sugary_drink_freq}
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    sugary_drink_freq: e.target.value as OnboardingSurveyRequest["sugary_drink_freq"],
                  }))
                }
              >
            ...
            <label>
              11. 야식 빈도 (밤 10시 이후)
              <select
                value={form.late_night_meal_freq}
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    late_night_meal_freq: e.target.value as OnboardingSurveyRequest["late_night_meal_freq"],
                  }))
                }
              >
            ...
            <label>
              12. 식후 10분 이상 걷기
              <select
                value={form.post_meal_walk}
                onChange={(e) =>
                  setForm((prev) => ({
                    ...prev,
                    post_meal_walk: e.target.value as OnboardingSurveyRequest["post_meal_walk"],
                  }))
                }
              >
